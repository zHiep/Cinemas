...
namespace Cinemas.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public AdminAccountsController(DbCinemasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var dbCinemasContext = _context.Accounts.Include(a => a.Role);
        ...
        public async Task<IActionResult> Create([Bind("Idaccount,Username,Password,RoleId,Avatar,Active")] Account account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Idaccount,Username,Password,RoleId,Avatar,Active")] Account account)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbCinemasContext.Accounts'  is null.");
            }
            var account = await _context.Accounts.FindAsync(id);
            if (account != null)
            {
